...
class SelectColorViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let seachResultViewController = segue.destination as! SearchResultViewController
        seachResultViewController.selectedCategory = selectedCategory
        seachResultViewController.selectedColor = CheckedButtonTag
    }
}
